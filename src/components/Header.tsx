      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link to="/marketplace" onClick={handleNavClick} className={`font-medium pb-1 transition-all ${isActive("/marketplace") ? "text-blue-900 border-b-2 border-blue-900" : "text-gray-600 hover:text-blue-900 hover:border-b-2 hover:border-blue-900"}`}>
              Marketplace
            </Link>
            <Link to="/login">
        ...
        {isMenuOpen && (
          <nav className="md:hidden py-4 space-y-4 border-t border-gray-200">
            ...
            <Link to="/marketplace" onClick={handleNavClick} className={`block w-full text-left font-medium pb-2 border-b-2 transition-all ${isActive("/marketplace") ? "text-blue-900 border-blue-900" : "text-gray-600 border-transparent hover:text-blue-900 hover:border-blue-900"}`}>
              Marketplace
            </Link>
